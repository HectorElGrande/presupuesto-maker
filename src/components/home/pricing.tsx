    ...
    >
      ...
      >
        <TabsList className="h-11 px-1.5 rounded-full bg-primary/5">
          <TabsTrigger value="monthly" className="py-1.5 rounded-full cursor-pointer">
            Monthly
          </TabsTrigger>
          <TabsTrigger value="yearly" className="py-1.5 rounded-full cursor-pointer">
        ...
        {plans.map((plan) => (
          ...
          >
            ...
            <Button
              ...
              size="lg"
              className="w-full mt-6 text-base cursor-pointer"
            >
              {plan.buttonText}
            </Button>
